...
import com.example.popcorn.databinding.ActorsFragmentBinding

class ActorsFragment : Fragment() {

    private val viewModel by activityViewModels<MovieDetailsViewModel>()

    private var binding: ActorsFragmentBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        binding?.let {
            ...
            it.actorsRecyclerView.adapter = adapter
            it.actorsRecyclerView.layoutManager =
